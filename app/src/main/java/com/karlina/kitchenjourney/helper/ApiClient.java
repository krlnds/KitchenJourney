...
public class ApiClient {
        ...
        public static final String BASE_URL = "http://10.0.2.2/KitchenJourney/users/";
    public static final String BASE_URL_IMAGE = "http://10.0.2.2/KitchenJourney/users/images/ ";
